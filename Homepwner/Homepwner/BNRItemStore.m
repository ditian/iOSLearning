...
// BNRItemStore will be a singleton (only one instance).
...
@property (nonatomic) NSMutableArray *privateItems;  // Internal use only. Backs up the immutable array allItems.
...
// Right before this method is called, there is no instance for this method to be called upon. So it is a class method.
+ (instancetype)sharedStore
{
    static BNRItemStore *sharedStore = nil;  // Will NOT be destroyed when the method is done executing.
...
- (NSArray *)allAssetTypes
{
    ...
    // Is this the first time the program being run?
...
#pragma mark - Core data saving and loading
