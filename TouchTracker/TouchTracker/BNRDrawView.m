...
// weak to prevent this from becoming a dangling pointer when a line in finishedLines deallocates.
...
- (instancetype)initWithFrame:(CGRect)r
{
    ...
    if (self) {
        ...
        // Prevent the first tap creating a red dot
...
# pragma mark - Gestures/Selectors
...
- (void)tap:(UIGestureRecognizer *)gr
{
    ...
    if (self.selectedLine) {
        ...
        // Make ourselves the target of menu item acion messages
...
- (void)moveLine:(UIPanGestureRecognizer *)gr
{
    ...
    if (gr.state == UIGestureRecognizerStateChanged) {
        ...
        // Add the translation to the current beginning and edn points of the line
